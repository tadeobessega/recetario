...
import htmlPolitica from './politica_privacidad.html';
...
export default {
  async fetch(request, env) {
    ...
    // Interceptamos la ruta exacta para la política de privacidad
    if (url.pathname === '/politica_privacidad.html') {
      return new Response(htmlPolitica, {
        headers: {
